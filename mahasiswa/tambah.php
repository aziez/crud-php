<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "INSERT INTO db_siswa(nim, nama, jkelamin, tgl_lahir, alamat, jurusan) VALUE ('$nim', '$nama', '$jkelamin', '$tgl_lahir', '$alamat', '$jurusan')";
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nama" name="nama" placeholder="Nama Siswa" type="text" class="form-control" required="required">
      </div>
    </div>
  </div>
  <div class="form-group row">
